      ...
      <div className="flex-grow" data-aos="fade-right">
        <div className="max-w-5xl">
          ...
          <Typography variant="subtitle2" className="mb-10">
            ...
            mission to transform the digital landscape one client at a time. By
            supporting our clients in discovering how they can embrace the
          ...
          <Typography variant="subtitle3" className="lg:max-w-[75%]">
            ...
            businesses can be turbocharged into new stages of growth. We have
            only just started to uncover the incredible applications of Web3. We
            want to help you discover your next great idea.
          </Typography>
        </div>
      </div>
      <div
        className="flex flex-col gap-6 text-center sm:gap-12 sm:text-left"
        data-aos="fade-left"
      >
        <div>
