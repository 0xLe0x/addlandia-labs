    ...
    <Container className="flex flex-col gap-16 py-28 sm:py-40 lg:gap-32 lg:py-80 xl:flex-row">
      <div className="flex-grow" data-aos="fade-right">
        ...
        <Typography variant="subtitle2" className="mb-10">
          ...
          transform the digital landscape one client at a time. By supporting
          our clients in discovering how they can embrace the latest
          technologies, we feel they are
        </Typography>
        <Typography variant="subtitle3" className="lg:max-w-[75%]">
          ...
          just started to uncover the incredible applications of Web3. We want
          to help you discover your next great idea.
        </Typography>
      </div>
      <div
        className="flex flex-col gap-6 text-center sm:gap-12 sm:text-left lg:min-w-[500px]"
        data-aos="fade-left"
      >
        <div>
